# ui/pages/main_page.py - ENHANCED VERSION with New Statistics Elements

"""
Main page layout - ENHANCED with new statistics elements
"""
...
def create_enhanced_stats_panels_hidden():
    """
    Enhanced statistics panels with NEW metrics - HIDDEN by default
    """
    panel_style_base = {
        'flex': '1',
        'padding': '20px',
    ...
    return html.Div(
        ...
        children=[
            ...
            # ENHANCED Statistics Panel with NEW metrics
            html.Div([
                ...
                # NEW ENHANCED STATS - with visual separator and highlighting
                html.Hr(style={
            ...
            # Active Devices Panel (unchanged)
            html.Div([
...
def create_main_layout(app_instance, main_logo_path, icon_upload_default, upload_component=None):
    """
    Creates the main application layout with ENHANCED statistics panels
    """
    ...
    layout = html.Div(
        children=[
            ...
            # ENHANCED Statistics Panels (HIDDEN until after processing)
