...
class EnhancedStatsComponent:
    ...
    def __init__(self):
        ...
        self.chart_theme = {
            'layout': {
                ...
                'colorway': [COLORS['accent'], COLORS['success'], COLORS['warning'], 
                           COLORS['critical'], '#42A5F5', '#66BB6A', '#FFA726', '#EF5350']
            }
        }
    
    def create_enhanced_stats_container(self):
        """Creates the complete enhanced statistics container with all panels"""
        return html.Div([
            # Custom header (same as original)
            self.create_custom_header(),
            
            # Row 1: Original Core Stats (Enhanced)
            html.Div(
                id='core-stats-panels-container',
                style={
                    'display': 'flex',
                    'flexDirection': 'row',
            ...
            # Row 2: Advanced Analytics Panels
            html.Div(
            ...
            # Row 3: Visual Charts Section
            self.create_charts_section(),
            
            # Row 4: Export and Tools Section
            self.create_export_tools_section(),
    ...
    def create_enhanced_access_events_panel(self):
        ...
        return html.Div([
            ...
            html.H1(id="enhanced-total-access-events-H1", style={
                'color': COLORS['text_primary'], 
                'marginBottom': '5px',
                'fontSize': '2.5rem'
            }),
            html.P(id="enhanced-event-date-range-P", style={
            ...
            # New: Trend indicator
            html.Div([
                html.Span(id="events-trend-indicator", style={
                    'fontSize': '1.2rem',
                    'fontWeight': 'bold'
                }),
                html.Span(" vs last period", style={
                    'fontSize': '0.8rem',
            ...
            html.P(id="avg-events-per-day", style={
                'color': COLORS['text_secondary'],
                'fontSize': '0.9rem',
                'marginTop': '10px'
            })
    ...
    def create_enhanced_statistics_panel(self):
        ...
        return html.Div([
            html.H3("Advanced Statistics", style={'color': COLORS['text_primary'], 'marginBottom': '15px'}),
            
            # Core stats (enhanced from original)
            html.Div([
                html.P(id="enhanced-stats-date-range-P", style={'color': COLORS['text_secondary'], 'margin': '5px 0'}),
                html.P(id="enhanced-stats-days-with-data-P", style={'color': COLORS['text_secondary'], 'margin': '5px 0'}),
                html.P(id="enhanced-stats-num-devices-P", style={'color': COLORS['text_secondary'], 'margin': '5px 0'}),
                html.P(id="enhanced-stats-unique-tokens-P", style={'color': COLORS['text_secondary'], 'margin': '5px 0'}),
            ]),
            ...
            html.Div([
                html.P(id="peak-hour-stat", style={'color': COLORS['text_secondary'], 'margin': '5px 0'}),
                html.P(id="busiest-day-stat", style={'color': COLORS['text_secondary'], 'margin': '5px 0'}),
                html.P(id="avg-session-length", style={'color': COLORS['text_secondary'], 'margin': '5px 0'}),
                html.P(id="compliance-score", style={'color': COLORS['text_secondary'], 'margin': '5px 0'})
            ])
        ], style=panel_style)
    ...
    def create_enhanced_active_devices_panel(self):
        ...
        return html.Div([
            ...
            html.Div([
                html.P(id="total-devices-summary", style={
                    'color': COLORS['text_primary'],
                    'fontSize': '1.2rem',
                    'fontWeight': 'bold',
                    'marginBottom': '10px'
                }),
                html.P(id="active-devices-today", style={
                    'color': COLORS['text_secondary'],
                    'marginBottom': '15px'
                })
            ]),
            ...
            html.Div([
                html.Table([
                    html.Thead(html.Tr([
                        ...
                        html.Th("TREND", style={'color': COLORS['text_primary'], 'fontSize': '0.8rem'})
                    ])),
                    html.Tbody(id='enhanced-most-active-devices-table-body')
    ...
    def create_peak_activity_panel(self):
        ...
        return html.Div([
            ...
            html.Div([
                html.H2(id="peak-hour-display", style={
                    'color': COLORS['success'],
                    'fontSize': '2rem',
                    'marginBottom': '5px'
                }),
                html.P("Peak Hour", style={
                    'color': COLORS['text_secondary'],
                    'fontSize': '0.9rem'
                })
            ]),
            ...
            html.Div([
                html.P(id="peak-day-display", style={
                    'color': COLORS['text_secondary'],
                    'marginBottom': '10px'
                }),
                html.P(id="peak-activity-events", style={
                    'color': COLORS['text_secondary'],
                    'fontSize': '0.9rem'
                })
            ]),
            ...
            html.Div(id="activity-level-indicator", style={
                'marginTop': '15px'
            })
        ], style=panel_style)
    ...
    def create_security_distribution_panel(self):
        ...
        return html.Div([
            ...
            html.Div(id="security-level-breakdown", children=[
                html.P("Loading security data...", style={'color': COLORS['text_secondary']})
            ]),
            ...
            html.Div([
                html.Hr(style={'borderColor': COLORS['border'], 'margin': '15px 0'}),
                html.Div([
                    html.H3(id="security-compliance-score", style={
                        'color': COLORS['critical'],
                        'fontSize': '1.8rem',
                        'marginBottom': '5px'
                    }),
                    html.P("Compliance Score", style={
                        'color': COLORS['text_secondary'],
                        'fontSize': '0.9rem'
                    })
                ])
    ...
    def create_user_patterns_panel(self):
        ...
        return html.Div([
            html.H3("User Patterns", style={'color': COLORS['text_primary'], 'marginBottom': '15px'}),
            
            # User activity metrics
            html.Div([
                html.P(id="most-active-user", style={
                    'color': COLORS['text_secondary'],
                    'marginBottom': '8px'
                }),
                html.P(id="avg-user-activity", style={
                    'color': COLORS['text_secondary'],
                    'marginBottom': '8px'
                }),
                html.P(id="unique-users-today", style={
                    'color': COLORS['text_secondary'],
                    'marginBottom': '15px'
                })
            ]),
            ...
            # Behavior insights
            html.Div([
                html.H4(id="primary-access-pattern", style={
                    'color': COLORS['accent'],
                    'fontSize': '1.1rem',
                    'marginBottom': '5px'
                }),
                html.P(id="access-pattern-description", style={
                    'color': COLORS['text_secondary'],
                    'fontSize': '0.85rem'
                })
            ])
    ...
    def create_charts_section(self):
        ...
        return html.Div([
            html.H3("Visual Analytics", style={
                'color': COLORS['text_primary'],
                'textAlign': 'center',
                'marginBottom': '20px',
                'fontSize': '1.5rem'
    ...
    def create_export_tools_section(self):
        """Creates export and tools section"""
        return html.Div([
            html.H4("Export & Tools", style={
                'color': COLORS['text_primary'],
                'textAlign': 'center',
                'marginBottom': '20px'
            }),
            ...
            html.Div([
                # Export options
                html.Div([
                    html.H5("Export Options", style={'color': COLORS['text_primary'], 'marginBottom': '15px'}),
                    dbc.ButtonGroup([
                        dbc.Button("📄 PDF Report", id="export-pdf-btn", color="success", size="sm"),
                        dbc.Button("📊 Excel Data", id="export-excel-btn", color="info", size="sm"),
                        dbc.Button("📈 Charts PNG", id="export-charts-btn", color="warning", size="sm"),
                        dbc.Button("💾 Raw JSON", id="export-json-btn", color="secondary", size="sm")
                ...
                # Analytics tools
                html.Div([
                    html.H5("Analytics Tools", style={'color': COLORS['text_primary'], 'marginBottom': '15px'}),
                    dbc.ButtonGroup([
                        dbc.Button("🔍 Anomaly Detection", id="anomaly-detection-btn", color="danger", size="sm"),
                        dbc.Button("📊 Custom Report", id="custom-report-btn", color="primary", size="sm"),
                        dbc.Button("⚡ Performance Metrics", id="performance-btn", color="info", size="sm"),
                        dbc.Button("🔔 Alert Setup", id="alert-setup-btn", color="warning", size="sm")
                    ], vertical=True, className="w-100")
                ], style={
                    'backgroundColor': COLORS['surface'],
                    'borderRadius': '8px',
            ...
            ], style={'display': 'flex', 'gap': '20px', 'width': '60%', 'margin': '0 auto'})
    ...
    def create_security_distribution_chart(self, device_attrs):
        ...
        fig = go.Figure(data=[go.Pie(
            ...
            marker_colors=[colors.get(level, COLORS['border']) for level in security_counts.index],
    ...
    def process_enhanced_stats(self, df, device_attrs=None):
        ...
        if timestamp_col in df.columns:
            ...
            stats['events_per_day'] = stats['total_events'] / max(stats['days_with_data'], 1)
        ...
        if doorid_col in df.columns:
            ...
            stats['devices_active_today'] = self._get_devices_active_today(df, doorid_col, timestamp_col)
            
        if userid_col in df.columns:
            stats['unique_users'] = df[userid_col].nunique()
            stats['avg_events_per_user'] = stats.get('total_events', 0) / max(stats['unique_users'], 1)
            stats['most_active_user'] = df[userid_col].value_counts().index[0] if not df.empty else 'N/A'
            
        # Security analysis
        if device_attrs is not None and not device_attrs.empty:
            stats['security_distribution'] = self._analyze_security_distribution(device_attrs)
